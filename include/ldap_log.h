...
/* LY: libreldap debug level, controlled by
 * ldap_set_option(LDAP_OPT_DEBUG_LEVEL) */
...
#define DebugTest(level) ((ldap_debug_mask | slap_syslog_mask) & (level))
...
LDAP_LUTIL_F(void) ldap_debug_va(const char *fmt, va_list args);
