...
AsnTypetoMatchingRuleTable directory_component_matching_table[] = {
    ...
    {{BASICTYPE_BOOLEAN, NULL, "1.3.6.1.4.1.1466.115.121.1.7", NULL},
     ...
     {BASICTYPE_NUMERIC_STR, "numericStringMatch",
      "1.3.6.1.4.1.1466.115.121.1.36", NULL},
     {BASICTYPE_PRINTABLE_STR, "caseIgnoreMatch",
      "1.3.6.1.4.1.1466.115.121.1.44", NULL},
     {BASICTYPE_UNIVERSAL_STR, "caseIgnoreMatch", NULL, NULL},
     {BASICTYPE_IA5_STR, "caseIgnoreMatch", "1.3.6.1.4.1.1466.115.121.1.26",
      NULL},
     ...
     {BASICTYPE_GENERALIZEDTIME, "generalizedTimeMatch",
      "1.3.6.1.4.1.1466.115.121.1.24", NULL},
     ...
     {TelephoneNumber, "telephoneNumberMatch", "1.3.6.1.4.1.1466.115.121.1.50",
      NULL},
     {FacsimileTelephoneNumber__telephoneNumber, "telephoneNumberMatch",
      "1.3.6.1.4.1.1466.115.121.1.22", NULL},
     {DirectoryString, "caseIgnoreMatch", "1.3.6.1.4.1.1466.115.121.1.15",
      NULL},
...
AsnTypetoSyntax asn_to_syntax_mapping_tbl[] = {
    ...
    {BASICTYPE_OCTETSTRING, "Octet String", "1.3.6.1.4.1.1466.115.121.1.40",
     NULL},
    {BASICTYPE_NULL, NULL, NULL, NULL},
    {BASICTYPE_OID, "OID", "1.3.6.1.4.1.1466.115.121.1.38", NULL},
    {BASICTYPE_REAL, NULL, NULL, NULL},
    {BASICTYPE_ENUMERATED, "Integer", "1.3.6.1.4.1.1466.115.121.1.27", NULL},
    {BASICTYPE_NUMERIC_STR, "Numeric String", "1.3.6.1.4.1.1466.115.121.1.36",
     NULL},
    {BASICTYPE_PRINTABLE_STR, "Printable String",
     "1.3.6.1.4.1.1466.115.121.1.44", NULL},
    ...
    {BASICTYPE_UTF8_STR, "Directory String", "1.3.6.1.4.1.1466.115.121.1.15",
     NULL},
    {BASICTYPE_UTCTIME, "UTC Time", "1.3.6.1.4.1.1466.115.121.1.53", NULL},
    {BASICTYPE_GENERALIZEDTIME, "Generalized Time",
     "1.3.6.1.4.1.1466.115.121.1.24", NULL},
    {BASICTYPE_GRAPHIC_STR, NULL, NULL, NULL},
    {BASICTYPE_VISIBLE_STR, "Directory String", "1.3.6.1.4.1.1466.115.121.1.15",
     NULL},
    {BASICTYPE_GENERAL_STR, NULL, NULL, NULL},
    {BASICTYPE_OBJECTDESCRIPTOR, "Object Class Description",
     "1.3.6.1.4.1.1466.115.121.1.37", NULL},
    ...
    {TelephoneNumber, "Telephone Number", "1.3.6.1.4.1.1466.115.121.1.50",
     NULL},
    {FacsimileTelephoneNumber__telephoneNumber, "Facsimile Telephone Number",
     "1.3.6.1.4.1.1466.115.121.1.22", NULL},
    {DirectoryString, "Directory String", "1.3.6.1.4.1.1466.115.121.1.15",
     NULL},
    {ASN_COMP_CERTIFICATE, "componentCertificate", "1.2.36.79672281.1.5.2",
     NULL},
    {ASNTYPE_END, NULL, NULL, NULL}};
...
AsnTypetoCompMatchingRule asntype_to_compMR_mapping_tbl[] = {
    ...
    {BASICTYPE_OCTETSTRING, "octetStringMatch", NULL,
     "octetStringOrderingMatch", NULL},
    ...
    {BASICTYPE_NUMERIC_STR, "numericStringMatch", NULL,
     "numericStringOrderingMatch", "numericStringSubstringsMatch"},
    {BASICTYPE_PRINTABLE_STR, "caseIgnoreMatch", "directoryStringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
    {BASICTYPE_UNIVERSAL_STR, "caseIgnoreMatch", "directoryStringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
    {BASICTYPE_IA5_STR, "caseIgnoreMatch", "IA5StringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
    {BASICTYPE_BMP_STR, "caseIgnoreMatch", "directoryStringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
    {BASICTYPE_UTF8_STR, "caseIgnoreMatch", "directoryStringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
    ...
    {BASICTYPE_VISIBLE_STR, "caseIgnoreMatch", "directoryStringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
    {BASICTYPE_GENERAL_STR, NULL, NULL, NULL, NULL},
    {BASICTYPE_OBJECTDESCRIPTOR, "objectIdentifierFirstComponentMatch", NULL,
     NULL, NULL},
    ...
    {BASICTYPE_RELATIVE_OID, "objectIdentifierFirstComponentMatch", NULL, NULL,
     NULL},
    ...
    {FacsimileTelephoneNumber__telephoneNumber, "caseIgnoreMatch",
     "directoryStringApproxMatch", "caseIgnoreOrderingMatch",
     "caseIgnoreSubstringsMatch"},
    {DirectoryString, "caseIgnoreMatch", "directoryStringApproxMatch",
     "caseIgnoreOrderingMatch", "caseIgnoreSubstringsMatch"},
...
AsnTypetoCompDesc asntype_to_compdesc_mapping_tbl[] = {
    {BASICTYPE_BOOLEAN,
     {-1,
      ...
      BASICTYPE_BOOLEAN,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentBool,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentBool,
      (ber_decoder_func *)BDecComponentBool,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_INTEGER,
     {-1,
      ...
      BASICTYPE_INTEGER,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentInt,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentInt,
      (ber_decoder_func *)BDecComponentInt,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_BITSTRING,
     {-1,
      ...
      BASICTYPE_BITSTRING,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentBits,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentBits,
      (ber_decoder_func *)BDecComponentBits,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_OCTETSTRING,
     {-1,
      ...
      BASICTYPE_OCTETSTRING,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentOcts,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentOcts,
      (ber_decoder_func *)BDecComponentOcts,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_NULL,
     {-1,
      ...
      BASICTYPE_NULL,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentNull,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentNull,
      (ber_decoder_func *)BDecComponentNull,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_OID,
     {-1,
      ...
      BASICTYPE_OID,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentOid,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentOid,
    ...
    {BASICTYPE_REAL,
     {-1,
      ...
      BASICTYPE_REAL,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentReal,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentReal,
      (ber_decoder_func *)BDecComponentReal,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_ENUMERATED,
     {-1,
      ...
      BASICTYPE_ENUMERATED,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentEnum,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentEnum,
      (ber_decoder_func *)BDecComponentEnum,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_NUMERIC_STR,
     {-1,
      ...
      BASICTYPE_NUMERIC_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentNumericString,
      (encoder_func *)NULL,
    ...
    {BASICTYPE_PRINTABLE_STR,
     {-1,
      ...
      BASICTYPE_PRINTABLE_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentPrintableString,
      (encoder_func *)NULL,
    ...
    {BASICTYPE_UNIVERSAL_STR,
     {-1,
      ...
      BASICTYPE_UNIVERSAL_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentUniversalString,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentUniversalString,
      (ber_decoder_func *)BDecComponentUniversalString,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_IA5_STR,
     {-1,
      ...
      BASICTYPE_IA5_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentIA5String,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentIA5String,
      (ber_decoder_func *)BDecComponentIA5String,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_BMP_STR,
     {-1,
      ...
      BASICTYPE_BMP_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentBMPString,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentBMPString,
      (ber_decoder_func *)BDecComponentBMPString,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_UTF8_STR,
     {-1,
      ...
      BASICTYPE_UTF8_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentUTF8String,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentUTF8String,
      (ber_decoder_func *)BDecComponentUTF8String,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_UTCTIME,
     {-1,
      ...
      BASICTYPE_UTCTIME,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentUTCTime,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentUTCTime,
      (ber_decoder_func *)BDecComponentUTCTime,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_VISIBLE_STR,
     {-1,
      ...
      BASICTYPE_VISIBLE_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentVisibleString,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentVisibleString,
      (ber_decoder_func *)BDecComponentVisibleString,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_VIDEOTEX_STR,
     {-1,
      ...
      BASICTYPE_VIDEOTEX_STR,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentTeletexString,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentTeletexString,
      (ber_decoder_func *)BDecComponentTeletexString,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {BASICTYPE_OCTETCONTAINING,
     {-1,
      ...
      (encoder_func *)NULL,
      (encoder_func *)NULL,
      (gser_decoder_func *)NULL,
      (ber_decoder_func *)NULL,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
      NULL}},
    {BASICTYPE_BITCONTAINING,
    ...
    {BASICTYPE_RELATIVE_OID,
     {-1,
      ...
      BASICTYPE_RELATIVE_OID,
      (encoder_func *)NULL,
      (encoder_func *)GEncComponentRelativeOid,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentRelativeOid,
      (ber_decoder_func *)BDecComponentRelativeOid,
      (comp_free_func *)NULL,
      (extract_component_from_id_func *)NULL,
    ...
    {RDNSequence,
     {-1,
      ...
      ASN_COMPOSITE,
      RDNSequence,
      (encoder_func *)ConvertRDNSequence2RFC2253,
      (encoder_func *)NULL,
      (encoder_func *)NULL,
      (gser_decoder_func *)GDecComponentRDNSequence,
