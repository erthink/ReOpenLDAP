 ...
 *    "AuthorityKeyIdentifierDefinition" ASN.1 module
 * encode/decode/extracting/matching/free C src. This file was generated by
 * modified eSMACC compiler Wed Dec  8 22:22:49 2004 The generated files are
...
int MatchingComponentGeneralName(char *oid, ComponentSyntaxInfo *csi_attr,
  ...
  case GENERALNAME_REGISTEREDID:
    rc = MatchingComponentOid(oid, (ComponentSyntaxInfo *)(v1->a.registeredID),
                              (ComponentSyntaxInfo *)(v2->a.registeredID));
    break;
  default:
    return LDAP_PROTOCOL_ERROR;
  }
