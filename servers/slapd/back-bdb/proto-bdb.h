...
AttrInfo *bdb_attr_mask(struct bdb_info *bdb, AttributeDescription *desc);
...
int bdb_dn2id_parent(Operation *op, DB_TXN *txn, EntryInfo *ei, ID *idp);

int bdb_dup_compare(DB *db, const DBT *usrkey, const DBT *curkey);
