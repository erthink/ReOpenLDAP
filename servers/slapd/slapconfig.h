...
/* slapconfig.h - configuration abstraction structure */
...
typedef int(ConfigLDAPdel)(CfEntryInfo *ce, Operation *op);
#endif
...
LDAP_SLAPD_V(int) config_fp_parse_line(ConfigArgs *c);

LDAP_SLAPD_V(int) config_register_schema(ConfigTable *ct, ConfigOCs *co);
LDAP_SLAPD_V(int) config_del_vals(ConfigTable *cf, ConfigArgs *c);
LDAP_SLAPD_V(int) config_get_vals(ConfigTable *ct, ConfigArgs *c);
LDAP_SLAPD_V(int) config_add_vals(ConfigTable *ct, ConfigArgs *c);

LDAP_SLAPD_V(void) init_config_argv(ConfigArgs *c);
LDAP_SLAPD_V(int) init_config_attrs(ConfigTable *ct);
LDAP_SLAPD_V(int) init_config_ocs(ConfigOCs *ocs);
LDAP_SLAPD_V(void) config_parse_ldif(ConfigArgs *c);
LDAP_SLAPD_V(int) config_parse_vals(ConfigTable *ct, ConfigArgs *c, int valx);
...
LDAP_SLAPD_V(int) slap_ldap_response_code_register(struct berval *bv, int err);
