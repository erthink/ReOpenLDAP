...
extern int monitor_cache_get(monitor_info_t *mi, struct berval *ndn,
                             Entry **ep);
extern int monitor_cache_remove(monitor_info_t *mi, struct berval *ndn,
                                Entry **ep);
extern int monitor_cache_dn2entry(Operation *op, SlapReply *rs,
                                  struct berval *ndn, Entry **ep,
                                  Entry **matched);
...
extern int monitor_entry_create(Operation *op, SlapReply *rs,
...
extern Entry *monitor_back_entry_stub(struct berval *pdn, struct berval *pndn,
...
extern int monitor_back_register_overlay(BackendDB *be,
                                         struct slap_overinst *on,
                                         struct berval *ndn_out);
extern int monitor_back_register_backend_limbo(BackendInfo *bi);
extern int monitor_back_register_database_limbo(BackendDB *be,
                                                struct berval *ndn_out);
extern int monitor_back_register_overlay_info_limbo(slap_overinst *on);
extern int monitor_back_register_overlay_limbo(BackendDB *be,
                                               struct slap_overinst *on,
                                               struct berval *ndn_out);
extern monitor_subsys_t *monitor_back_get_subsys(const char *name);
extern monitor_subsys_t *monitor_back_get_subsys_by_dn(struct berval *ndn,
                                                       int sub);
extern int monitor_back_is_configured(void);
extern int monitor_back_register_entry(Entry *e, monitor_callback_t *cb,
                                       monitor_subsys_t *mss,
                                       unsigned long flags);
extern int monitor_back_register_entry_parent(Entry *e, monitor_callback_t *cb,
                                              monitor_subsys_t *mss,
                                              unsigned long flags,
                                              struct berval *base, int scope,
                                              struct berval *filter);
extern int monitor_search2ndn(struct berval *base, int scope,
                              struct berval *filter, struct berval *ndn);
extern int monitor_back_register_entry_attrs(struct berval *ndn, Attribute *a,
                                             monitor_callback_t *cb,
                                             struct berval *base, int scope,
                                             struct berval *filter);
extern int monitor_back_register_entry_callback(struct berval *ndn,
                                                monitor_callback_t *cb,
                                                struct berval *base, int scope,
                                                struct berval *filter);
extern int monitor_back_unregister_entry(struct berval *ndn);
extern int monitor_back_unregister_entry_parent(struct berval *nrdn,
                                                monitor_callback_t *target_cb,
                                                struct berval *base, int scope,
                                                struct berval *filter);
extern int monitor_back_unregister_entry_attrs(struct berval *ndn, Attribute *a,
                                               monitor_callback_t *cb,
                                               struct berval *base, int scope,
                                               struct berval *filter);
extern int monitor_back_unregister_entry_callback(struct berval *ndn,
                                                  monitor_callback_t *cb,
                                                  struct berval *base,
                                                  int scope,
                                                  struct berval *filter);
