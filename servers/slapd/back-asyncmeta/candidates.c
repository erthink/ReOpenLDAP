...
static a_metasubtree_t *asyncmeta_subtree_match(a_metatarget_t *mt,
                                                struct berval *ndn, int scope) {
 ...
 */
int asyncmeta_is_candidate(a_metatarget_t *mt, struct berval *ndn, int scope) {
  struct berval rdn;
 ...
 */
int asyncmeta_select_unique_candidate(a_metainfo_t *mi, struct berval *ndn) {
 ...
 */
int asyncmeta_clear_unused_candidates(Operation *op, int candidate,
                                      a_metaconn_t *mc, SlapReply *candidates) {
...
int asyncmeta_clear_one_msc(Operation *op, a_metaconn_t *mc, int candidate) {
  ...
  if (msc->msc_ld != NULL) {
    ...
    snprintf(buf, sizeof(buf),
             "asyncmeta_clear_one_msc ldap_unbind_ext[%d] ld=%p", candidate,
             (void *)msc->msc_ld);
