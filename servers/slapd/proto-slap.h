...
LDAP_SLAPD_F (int) slap_biglock_call_be (
 ...
 * acl.c
 */
LDAP_SLAPD_F (int) access_allowed_mask (
	Operation *op,
...
LDAP_SLAPD_F (int) slap_access_allowed (
	Operation		*op,
	Entry			*e,
	...
	AccessControlState	*state,
	slap_mask_t		*maskp );
LDAP_SLAPD_F (int) slap_access_always_allowed (
	Operation		*op,
	Entry			*e,
	AttributeDescription	*desc,
	struct berval		*val,
...
LDAP_SLAPD_F (int) acl_check_modlist (
...
LDAP_SLAPD_F (int) acl_get_part (
	struct berval	*list,
	int		ix,
	char		sep,
	struct berval	*bv );
LDAP_SLAPD_F (int) acl_match_set (
	struct berval *subj,
	Operation *op,
	Entry *e,
	struct berval *default_set_attribute );
LDAP_SLAPD_F (int) acl_string_expand (
...
LDAP_SLAPD_F (int) parse_acl ( Backend *be,
 ...
 * ad.c
 */
LDAP_SLAPD_F (int) slap_str2ad (
	const char *,
	AttributeDescription **ad,
	const char **text );

LDAP_SLAPD_F (int) slap_bv2ad (
	struct berval *bv,
	AttributeDescription **ad,
	const char **text );
...
LDAP_SLAPD_F (int) is_ad_subtype (
	AttributeDescription *sub,
	AttributeDescription *super );

LDAP_SLAPD_F (int) ad_inlist (
	AttributeDescription *desc,
	AttributeName *attrs );
...
LDAP_SLAPD_F (int) slap_bv2undef_ad (
	struct berval *bv,
	AttributeDescription **ad,
	const char **text,
	unsigned proxied );

LDAP_SLAPD_F (AttributeDescription *) slap_bv2tmp_ad (
	struct berval *bv,
	void *memctx );

LDAP_SLAPD_F (int) slap_ad_undef_promote (
	char *name,
	AttributeType *nat );

LDAP_SLAPD_F (AttributeDescription *) ad_find_tags (
	AttributeType *type,
	struct berval *tags );

LDAP_SLAPD_F (AttributeName *) str2anlist ( AttributeName *an,
	char *str, const char *brkstr );
LDAP_SLAPD_F (void) anlist_free ( AttributeName *an,
	int freename, void *ctx );

LDAP_SLAPD_F (char **) anlist2charray_x (
 ...
 * add.c
 */
LDAP_SLAPD_F (int) slap_mods2entry ( Modifications *mods, Entry **e,
	int initial, int dup, const char **text, char *textbuf, size_t textlen );

LDAP_SLAPD_F (int) slap_entry2mods ( Entry *e,
...
LDAP_SLAPD_F (int) attr_valfind ( Attribute *a,
	unsigned flags,
	struct berval *val,
	unsigned *slot,
	void *ctx );
LDAP_SLAPD_F (int) attr_valadd ( Attribute *a,
	BerVarray vals,
	BerVarray nvals,
	int num );
LDAP_SLAPD_F (int) attr_merge ( Entry *e,
	AttributeDescription *desc,
	BerVarray vals,
	BerVarray nvals );
LDAP_SLAPD_F (int) attr_merge_one ( Entry *e,
	AttributeDescription *desc,
	struct berval *val,
	struct berval *nval );
LDAP_SLAPD_F (int) attr_normalize ( AttributeDescription *desc,
	BerVarray vals, BerVarray *nvalsp, void *memctx );
LDAP_SLAPD_F (int) attr_normalize_one ( AttributeDescription *desc,
	struct berval *val, struct berval *nval, void *memctx );
LDAP_SLAPD_F (int) attr_merge_normalize ( Entry *e,
	AttributeDescription *desc,
	BerVarray vals, void *memctx );
LDAP_SLAPD_F (int) attr_merge_normalize_one ( Entry *e,
	AttributeDescription *desc,
	struct berval *val, void *memctx );
LDAP_SLAPD_F (Attribute *) attrs_find (
	Attribute *a, AttributeDescription *desc );
LDAP_SLAPD_F (Attribute *) attr_find (
	Attribute *a, AttributeDescription *desc );
LDAP_SLAPD_F (int) attr_delete (
 ...
 * ava.c
 */
LDAP_SLAPD_F (int) get_ava (
	Operation *op,
	BerElement *ber,
	Filter *f,
	unsigned usage,
	const char **text );
LDAP_SLAPD_F (void) ava_free (
	Operation *op,
...
LDAP_SLAPD_F (BackendDB *) backend_db_init ( const char *type,
...
LDAP_SLAPD_F (BackendDB *) select_backend (
	struct berval * dn,
	int noSubordinates );

LDAP_SLAPD_F (int) be_issuffix ( Backend *be,
	struct berval *suffix );
LDAP_SLAPD_F (int) be_issubordinate ( Backend *be,
...
LDAP_SLAPD_F (int) be_entry_get_rw ( Operation *o,
...
#endif
LDAP_SLAPD_F (int) (slap_bi_op) ( BackendInfo *bi,
	slap_operation_t which, Operation *op, SlapReply *rs );

LDAP_SLAPD_F (int) be_entry_release_rw (
...
LDAP_SLAPD_F( int ) backend_check_controls (
	Operation *op,
	SlapReply *rs );
LDAP_SLAPD_F( int )	backend_check_restrictions (
	Operation *op,
	SlapReply *rs,
	struct berval *opdata );

LDAP_SLAPD_F( int )	backend_check_referrals (
	Operation *op,
	SlapReply *rs );

LDAP_SLAPD_F (int) backend_group (
	Operation *op,
	Entry *target,
...
LDAP_SLAPD_F (int) backend_attribute (
	Operation *op,
	Entry *target,
...
LDAP_SLAPD_F (int) backend_access (
	Operation		*op,
	Entry			*target,
	struct berval		*edn,
	AttributeDescription	*entry_at,
...
LDAP_SLAPD_F (int) backend_operational (
	Operation *op,
	SlapReply *rs
);
...
LDAP_SLAPD_F (void) overlay_destroy_one (
	BackendDB *be,
	slap_overinst *on );
...
LDAP_SLAPD_F (int) overlay_register_control (
	BackendDB *be,
	const char *oid );
LDAP_SLAPD_F (int) overlay_op_walk (
	Operation *op,
	SlapReply *rs,
	slap_operation_t which,
	slap_overinfo *oi,
	slap_overinst *on );
LDAP_SLAPD_F (int) overlay_entry_get_ov (
	Operation *op,
	struct berval *dn,
	ObjectClass *oc,
	AttributeDescription *ad,
	...
	Entry **e,
	slap_overinst *ov );
LDAP_SLAPD_F (int) overlay_entry_release_ov (
	Operation *op,
	Entry *e,
	int rw,
	slap_overinst *ov );
LDAP_SLAPD_F (void) overlay_insert (
	BackendDB *be, slap_overinst *on, slap_overinst ***prev, int idx );
LDAP_SLAPD_F (void) overlay_move (
	BackendDB *be, slap_overinst *on, int idx );
#ifdef SLAP_CONFIG_DELETE
LDAP_SLAPD_F (void) overlay_remove (
	BackendDB *be, slap_overinst *on, Operation *op );
LDAP_SLAPD_F (void) overlay_unregister_control (
	BackendDB *be,
	const char *oid );
#endif /* SLAP_CONFIG_DELETE */
LDAP_SLAPD_F (int) overlay_callback_after_backover (
...
LDAP_SLAPD_F (int) slap_cf_aux_table_parse( const char *word, void *bc, slap_cf_aux_table *tab0, const char *tabmsg );
LDAP_SLAPD_F (int) slap_cf_aux_table_unparse( void *bc, struct berval *bv, slap_cf_aux_table *tab0 );
...
LDAP_SLAPD_F (int) slap_compare_entry (
	Operation *op,
	Entry *e,
	AttributeAssertion *ava );
...
LDAP_SLAPD_F (int) test_comp_filter_entry (
	Operation* op,
	Entry* e,
	MatchingRuleAssertion* mr);

LDAP_SLAPD_F (int) dup_comp_filter (
	Operation* op,
	struct berval *bv,
	ComponentFilter *in_f,
	ComponentFilter **out_f );

LDAP_SLAPD_F (int) get_aliased_filter_aa (
	Operation* op,
	AttributeAssertion* a_assert,
	struct comp_attribute_aliasing* aa,
	const char** text );

LDAP_SLAPD_F (int) get_aliased_filter (
	Operation* op,
	MatchingRuleAssertion* ma,
	struct comp_attribute_aliasing* aa,
	const char** text );

LDAP_SLAPD_F (int) get_comp_filter (
	Operation* op,
	BerValue* bv,
	ComponentFilter** filt,
	const char **text );

LDAP_SLAPD_F (int) insert_component_reference (
	ComponentReference *cr,
	ComponentReference** cr_list );

LDAP_SLAPD_F (int) is_component_reference (
	char *attr );

LDAP_SLAPD_F (int) extract_component_reference (
	char* attr,
	ComponentReference** cr );

LDAP_SLAPD_F (int) componentFilterMatch (
	int *matchp,
	slap_mask_t flags,
	Syntax *syntax,
	MatchingRule *mr,
...
LDAP_SLAPD_F (int) directoryComponentsMatch (
        int *matchp,
        slap_mask_t flags,
        Syntax *syntax,
        MatchingRule *mr,
...
LDAP_SLAPD_F (int) allComponentsMatch (
        int *matchp,
        slap_mask_t flags,
        Syntax *syntax,
        MatchingRule *mr,
...
LDAP_SLAPD_F (ComponentReference*) dup_comp_ref (
	Operation *op,
	ComponentReference *cr );

LDAP_SLAPD_F (int) componentFilterValidate (
	Syntax *syntax,
	struct berval* bv );

LDAP_SLAPD_F (int) allComponentsValidate (
        Syntax *syntax,
		struct berval* bv );

LDAP_SLAPD_F (void) component_free (
	ComponentFilter *f );

LDAP_SLAPD_F (void) free_ComponentData (
	Attribute *a );
...
LDAP_SLAPD_F (void) slap_free_ctrls (
	Operation *op,
	LDAPControl **ctrls );
LDAP_SLAPD_F (int) slap_add_ctrls (
	Operation *op,
	SlapReply *rs,
	LDAPControl **ctrls );
LDAP_SLAPD_F (int) slap_parse_ctrl (
	Operation *op,
	SlapReply *rs,
	LDAPControl *control,
	const char **text );
LDAP_SLAPD_F (int) get_ctrls (
	Operation *op,
	SlapReply *rs,
	int senderrors );
LDAP_SLAPD_F (int) get_ctrls2 (
	Operation *op,
	SlapReply *rs,
	int senderrors,
	ber_tag_t ctag );
LDAP_SLAPD_F (int) register_supported_control2 (
...
#ifdef SLAP_CONFIG_DELETE
LDAP_SLAPD_F (int) unregister_supported_control (
	const char* controloid );
#endif /* SLAP_CONFIG_DELETE */
...
LDAP_SLAPD_F (int) get_supported_controls (
	char ***ctrloidsp, slap_mask_t **ctrlmasks );
LDAP_SLAPD_F (int) slap_find_control_id (
	const char *oid, int *cid );
LDAP_SLAPD_F (int) slap_global_control (
	Operation *op, const char *oid, int *cid );
LDAP_SLAPD_F (int) slap_remove_control (
	Operation	*op,
	SlapReply	*rs,
	int		ctrl,
	BI_chk_controls	fnc );
...
LDAP_SLAPD_F (int) config_generic_wrapper ( Backend *be,
...
LDAP_SLAPD_F (Connection *) connection_client_setup (
	ber_socket_t s,
...
LDAP_SLAPD_F (Connection *) connection_init (
	ber_socket_t s,
	Listener* url,
	const char* dnsname,
	const char* peername,
...
LDAP_SLAPD_F (void) connection_closing (
	Connection *c, const char *why );
LDAP_SLAPD_F (int) connection_valid( Connection *c );
LDAP_SLAPD_F (const char *) connection_state2str ( int state )
	__attribute__((const));
...
LDAP_SLAPD_F (ContentRule *) cr_find (
	const char *crname);
LDAP_SLAPD_F (ContentRule *) cr_bvfind (
...
LDAP_SLAPD_F(void) slap_queue_csn( Operation *, struct berval * );
...
LDAP_SLAPD_F (void) slapd_remove (ber_socket_t s, Sockbuf *sb,
...
LDAP_SLAPD_F (int) dnValidate (
	Syntax *syntax,
	struct berval *val );
LDAP_SLAPD_F (int) rdnValidate (
	Syntax *syntax,
	struct berval *val );
...
LDAP_SLAPD_F (int) dnPrettyNormal (
	Syntax *syntax,
	struct berval *val,
...
LDAP_SLAPD_F (int) dnRelativeMatch (
	int *matchp,
	slap_mask_t flags,
	Syntax *syntax,
	MatchingRule *mr,
...
LDAP_SLAPD_F (void) build_new_dn (
...
LDAP_SLAPD_F (int) dnPrettyNormalDN( Syntax *syntax, struct berval *val, LDAPDN *dn, int flags, void *ctx );
...
LDAP_SLAPD_F (int) extop_register_ex (
...
LDAP_SLAPD_F (int) extop_unregister (
...
LDAP_SLAPD_F (void) filter2bv_undef_x( Operation *op, Filter *f, int noundef, struct berval *bv );
LDAP_SLAPD_F (Filter *) filter_dup( Filter *f, void *memctx );

LDAP_SLAPD_F (int) get_vrFilter ( Operation *op, BerElement *ber,
	ValuesReturnFilter **f,
	const char **text );

LDAP_SLAPD_F (void) vrFilter_free( Operation *op, ValuesReturnFilter *f );
LDAP_SLAPD_F (void) vrFilter2bv( Operation *op, ValuesReturnFilter *f, struct berval *fstr );
 ...
 * ldapsync.c
 */
LDAP_SLAPD_F (void) slap_insert_csn_sids (
				struct sync_cookie *ck, int, int, struct berval * );
LDAP_SLAPD_F (int) slap_build_syncUUID_set (
				Operation *, BerVarray *, Entry * );
LDAP_SLAPD_F (int) slap_check_same_server (
 ...
 * limits.c
 */
LDAP_SLAPD_F (int) limits_parse (
	Backend *be, const char *fname, int lineno,
	int argc, char **argv );
LDAP_SLAPD_F (int) limits_parse_one ( const char *arg,
	struct slap_limits_set *limit );
LDAP_SLAPD_F (int) limits_check (
	Operation *op, SlapReply *rs );
LDAP_SLAPD_F (int) limits_unparse_one (
	struct slap_limits_set *limit, int which, struct berval *bv, ber_len_t buflen );
LDAP_SLAPD_F (int) limits_unparse (
	struct slap_limits *limit, struct berval *bv, ber_len_t buflen );
LDAP_SLAPD_F (void) limits_free_one (
 ...
 * lock.c
 */
LDAP_SLAPD_F (FILE *) lock_fopen ( const char *fname,
...
LDAP_SLAPD_F (void *) module_resolve (
...
LDAP_SLAPD_F (int) mr_add ( LDAPMatchingRule *mr,
	slap_mrule_defs_rec *def,
	MatchingRule * associated,
	const char **err );
LDAP_SLAPD_F (void) mr_destroy( void );

LDAP_SLAPD_F (int) register_matching_rule (
	slap_mrule_defs_rec *def );
...
LDAP_SLAPD_F (int) mr_usable_with_at ( MatchingRule *mr,
	AttributeType *at );
LDAP_SLAPD_F (int) mr_make_syntax_compat_with_mr (
	Syntax		*syn,
	MatchingRule	*mr );
LDAP_SLAPD_F (int) mr_make_syntax_compat_with_mrs (
	const char *syntax,
	char *const *mrs );
 ...
 * mra.c
 */
LDAP_SLAPD_F (int) get_mra (
	Operation *op,
	BerElement *ber,
	Filter *f,
	const char **text );
LDAP_SLAPD_F (void) mra_free (
	Operation *op,
	MatchingRuleAssertion *mra,
	int freeit );

/* oc.c */
LDAP_SLAPD_F (int) oc_add (
	LDAPObjectClass *oc,
	int user,
	ObjectClass **soc,
	ObjectClass *prev,
...
LDAP_SLAPD_F (ObjectClass *) oc_find (
	const char *ocname);
LDAP_SLAPD_F (ObjectClass *) oc_bvfind (
	struct berval *ocname);
LDAP_SLAPD_F (ObjectClass *) oc_bvfind_undef (
	struct berval *ocname);
LDAP_SLAPD_F (int) is_object_subclass (
	ObjectClass *sup,
	ObjectClass *sub );

LDAP_SLAPD_F (int) is_entry_objectclass (
...
LDAP_SLAPD_F (void) oidm_unparse (
	BerVarray *bva, OidMacro *start, OidMacro *end, int system );
LDAP_SLAPD_F (int) parse_oidm (
...
LDAP_SLAPD_F (Operation *) slap_op_alloc (
 ...
 * referral.c
 */
LDAP_SLAPD_F (int) validate_global_referral (
	const char *url );

LDAP_SLAPD_F (BerVarray) get_entry_referrals (
	Operation *op, Entry *e );

LDAP_SLAPD_F (BerVarray) referral_rewrite (
	BerVarray refs,
	struct berval *base,
	struct berval *target,
	int scope );

LDAP_SLAPD_F (int) get_alias_dn (
	Entry *e,
	struct berval *ndn,
	int *err,
	const char **text );
...
LDAP_SLAPD_F (void) rs_flush_entry ( Operation *op,
	SlapReply *rs, slap_overinst *on );
LDAP_SLAPD_F (void) rs_replace_entry ( Operation *op,
	SlapReply *rs, slap_overinst *on, Entry *e );
LDAP_SLAPD_F (int) rs_entry2modifiable ( Operation *op,
	SlapReply *rs, slap_overinst *on );
...
LDAP_SLAPD_F (int) slap_read_controls ( Operation *op, SlapReply *rs,
	Entry *e, const struct berval *oid, LDAPControl **ctrl );

LDAP_SLAPD_F (int) str2result ( char *s,
...
LDAP_SLAPD_F (int) root_dse_info (
	Connection *conn,
	Entry **e,
	const char **text );

LDAP_SLAPD_F (int) root_dse_read_file (
	const char *file);

LDAP_SLAPD_F (int) slap_discover_feature (
	slap_bindconf	*sb,
	const char	*attr,
	const char	*val );
...
LDAP_SLAPD_F (int) slap_sasl_rewrite_config (
	const char *fname,
	int lineno,
	int argc,
	char **argv );
...
LDAP_SLAPD_F (int) authzValidate (
...
LDAP_SLAPD_F (int) authzMatch (
	...
	void *assertedValue );
#endif
LDAP_SLAPD_F (int) authzPretty (
	Syntax *syntax,
	struct berval *val,
	struct berval *out,
	void *ctx );
LDAP_SLAPD_F (int) authzNormalize (
	slap_mask_t usage,
	Syntax *syntax,
	MatchingRule *mr,
	struct berval *val,
...
LDAP_SLAPD_F( int ) numericoidValidate (
	Syntax *syntax,
		struct berval *in );
LDAP_SLAPD_F( int ) numericStringValidate (
	Syntax *syntax,
	struct berval *in );
LDAP_SLAPD_F( int ) octetStringMatch (
	int *matchp,
	slap_mask_t flags,
	Syntax *syntax,
	MatchingRule *mr,
	struct berval *value,
	void *assertedValue );
LDAP_SLAPD_F( int ) octetStringOrderingMatch (
	int *matchp,
	slap_mask_t flags,
	Syntax *syntax,
	MatchingRule *mr,
...
LDAP_SLAPD_F (int) parse_cr (
	struct config_args_s *ca, ContentRule **scr );
LDAP_SLAPD_F (int) parse_oc (
	struct config_args_s *ca, ObjectClass **soc, ObjectClass *prev );
LDAP_SLAPD_F (int) parse_at (
	struct config_args_s *ca, AttributeType **sat, AttributeType *prev );
LDAP_SLAPD_F (char *) scherr2str(int code) __attribute__((const));
LDAP_SLAPD_F (int) dscompare ( const char *s1, const char *s2del,
	char delim );
LDAP_SLAPD_F (int) parse_syn (
	struct config_args_s *ca, Syntax **sat, Syntax *prev );

/*
 * sessionlog.c
 */
LDAP_SLAPD_F (int) slap_send_session_log (
					Operation *, Operation *, SlapReply *);
LDAP_SLAPD_F (int) slap_add_session_log (
					Operation *, Operation *, Entry * );

/*
 * sl_malloc.c
 */
LDAP_SLAPD_F (void *) slap_sl_malloc (
	ber_len_t size, void *ctx );
LDAP_SLAPD_F (void *) slap_sl_realloc (
	void *block, ber_len_t size, void *ctx );
LDAP_SLAPD_F (void *) slap_sl_calloc (
	ber_len_t nelem, ber_len_t size, void *ctx );
LDAP_SLAPD_F (void) slap_sl_free (
	void *, void *ctx );
LDAP_SLAPD_F (void) slap_sl_release (
	void *, void *ctx );
LDAP_SLAPD_F (void *) slap_sl_mark (
	void *ctx );
...
LDAP_SLAPD_F (void *) slap_sl_mem_create (
...
LDAP_SLAPD_F (int)  syncrepl_add_glue (
					Operation*, Entry* );
LDAP_SLAPD_F (void) syncrepl_diff_entry (
...
/* syntax.c */
LDAP_SLAPD_F (int) syn_is_sup (
	Syntax *syn,
	Syntax *sup );
LDAP_SLAPD_F (Syntax *) syn_find (
	const char *synname );
LDAP_SLAPD_F (Syntax *) syn_find_desc (
	const char *syndesc, int *slen );
LDAP_SLAPD_F (int) syn_add (
	LDAPSyntax *syn,
	int user,
...
LDAP_SLAPD_F (int) register_syntax (
	slap_syntax_defs_rec *def );
 ...
 * value.c
 */
LDAP_SLAPD_F (int) asserted_value_validate_normalize (
	AttributeDescription *ad,
	MatchingRule *mr,
	unsigned usage,
	struct berval *in,
...
LDAP_SLAPD_F (int) value_match (
	...
	void *v2,
	const char ** text );
LDAP_SLAPD_F (int) value_find_ex (
	AttributeDescription *ad,
	unsigned flags,
	BerVarray values,
	struct berval *value,
...
LDAP_SLAPD_F (int) ordered_value_add (
	Entry *e,
	AttributeDescription *ad,
	Attribute *a,
	BerVarray vals,
...
LDAP_SLAPD_F (int) ordered_value_validate (
	AttributeDescription *ad,
	struct berval *in,
	int mop );

LDAP_SLAPD_F (int) ordered_value_pretty (
	AttributeDescription *ad,
	struct berval *val,
	struct berval *out,
	void *ctx );

LDAP_SLAPD_F (int) ordered_value_normalize (
	slap_mask_t usage,
	AttributeDescription *ad,
	MatchingRule *mr,
	struct berval *val,
...
LDAP_SLAPD_F (int) ordered_value_match (
	int *match,
	AttributeDescription *ad,
	MatchingRule *mr,
	unsigned flags,
...
LDAP_SLAPD_F (void) ordered_value_renumber (
	Attribute *a );

LDAP_SLAPD_F (int) ordered_value_sort (
	Attribute *a,
	int do_renumber );

LDAP_SLAPD_F (int) value_add (
	BerVarray *vals,
	BerVarray addvals );
LDAP_SLAPD_F (int) value_add_one (
	BerVarray *vals,
	const struct berval *addval );
LDAP_SLAPD_F (int) value_add_one_str (
	BerVarray *vals,
	const char* str );
LDAP_SLAPD_F (int) value_add_one_int (
	BerVarray *vals,
	int x );
LDAP_SLAPD_F (int) value_join_str (
	BerVarray	vals,
	const char* comma,
	BerValue	*dest );
...
LDAP_SLAPD_F (int) fe_acl_group (
	...
	ObjectClass *group_oc,
	AttributeDescription *group_at );
LDAP_SLAPD_F (int) fe_acl_attribute (
	Operation *op,
	Entry	*target,
	struct berval	*edn,
	AttributeDescription *entry_at,
	BerVarray *vals,
	slap_access_t access );
LDAP_SLAPD_F (int) fe_access_allowed (
	Operation		*op,
	Entry			*e,
	AttributeDescription	*desc,
	struct berval		*val,
