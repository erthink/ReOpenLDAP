...
int slap_get_op_abandon(const struct Operation *op) { return op->_o_abandon; }

ATTRIBUTE_NO_SANITIZE_THREAD
int slap_get_op_cancel(const struct Operation *op) { return op->_o_cancel; }

ATTRIBUTE_NO_SANITIZE_THREAD
void slap_set_op_abandon(struct Operation *op, int v) { op->_o_abandon = v; }

ATTRIBUTE_NO_SANITIZE_THREAD
void slap_set_op_cancel(struct Operation *op, int v) { op->_o_cancel = v; }

ATTRIBUTE_NO_SANITIZE_THREAD
int slap_tsan__read_int(volatile int *ptr) { return *ptr; }

ATTRIBUTE_NO_SANITIZE_THREAD
char slap_tsan__read_char(volatile char *ptr) { return *ptr; }

ATTRIBUTE_NO_SANITIZE_THREAD
void *slap_tsan__read_ptr(void *ptr) { return *(void *volatile *)ptr; }
