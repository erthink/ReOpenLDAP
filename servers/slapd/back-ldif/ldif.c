...
static int ldif_back_entry_release_rw(Operation *op, Entry *e, int rw) {
  ID id = e->e_id;
...
static ID ldif_tool_dn2id_get(BackendDB *be, struct berval *dn) {
  struct ldif_tool *tl = &((struct ldif_info *)be->be_private)->li_tool;
...
static ID ldif_tool_entry_modify(BackendDB *be, Entry *e, struct berval *text) {
  int rc;
  const char *errmsg = NULL;
  struct berval path;
  Operation op = {0};
