...
int ldap_int_thread_initialize(void) { return 0; }
...
int ldap_pvt_thread_join(ldap_pvt_thread_t thread, void **status) {
  if (status != NULL)
    *status = ldap_int_status;
  return 0;
}
...
int ldap_pvt_thread_cond_destroy(ldap_pvt_thread_cond_t *cond) { return 0; }

int ldap_pvt_thread_cond_signal(ldap_pvt_thread_cond_t *cond) { return 0; }
...
int ldap_pvt_thread_mutex_lock(ldap_pvt_thread_mutex_t *mutex) { return 0; }

int ldap_pvt_thread_mutex_trylock(ldap_pvt_thread_mutex_t *mutex) { return 0; }

int ldap_pvt_thread_mutex_unlock(ldap_pvt_thread_mutex_t *mutex) { return 0; }

int ldap_pvt_thread_mutex_recursive_init(
...
int ldap_pvt_thread_mutex_recursive_lock(
    ldap_pvt_thread_mutex_recursive_t *mutex)
    LDAP_GCCATTR((alias("ldap_pvt_thread_mutex_lock")));
int ldap_pvt_thread_mutex_recursive_trylock(
    ldap_pvt_thread_mutex_recursive_t *mutex)
    LDAP_GCCATTR((alias("ldap_pvt_thread_mutex_trylock")));
int ldap_pvt_thread_mutex_recursive_unlock(
    ldap_pvt_thread_mutex_recursive_t *mutex)
...
void ldap_pvt_thread_pool_idle(ldap_pvt_thread_pool_t *pool) { return; }
...
int ldap_pvt_thread_pool_pause(ldap_pvt_thread_pool_t *tpool) { return (0); }

int ldap_pvt_thread_pool_resume(ldap_pvt_thread_pool_t *tpool) { return (0); }

int ldap_pvt_thread_pool_pausing(ldap_pvt_thread_pool_t *tpool) { return (0); }
...
int ldap_pvt_thread_key_create(ldap_pvt_thread_key_t *key) { return (0); }
