 ...
 */
ber_tag_t ber_skip_raw(BerElement *ber, struct berval *bv) {
...
int ber_decode_int(const struct berval *bv, ber_int_t *num) {
...
ber_tag_t ber_scanf(BerElement *ber, const char *fmt, ...) {
  ...
  for (rc = 0; *fmt && rc != LBER_DEFAULT; fmt++) {
    ...
    {
      bgbvr cookie = {ChArray, LBER_BV_ALLOC | LBER_BV_STRING, sizeof(char *)};
      rc = ber_get_stringbvl(ber, &cookie);
