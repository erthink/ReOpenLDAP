 ...
 * Initialize context
 */
void lutil_HASHInit(lutil_HASH_CTX *ctx) { ctx->hash = HASH_OFFSET; }
 ...
 * Save hash
 */
void lutil_HASHFinal(unsigned char *digest, lutil_HASH_CTX *ctx) {
 ...
 * Initialize context
 */
void lutil_HASH64Init(lutil_HASH_CTX *ctx) { ctx->hash64 = HASH64_OFFSET; }
 ...
 * Save hash
 */
void lutil_HASH64Final(unsigned char *digest, lutil_HASH_CTX *ctx) {
